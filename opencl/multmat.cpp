...
int main(int argc, char **argv){
	...
	cl::Buffer vmat1(context,CL_MEM_READ_WRITE,matsize1);
	cl::Buffer vmat2(context,CL_MEM_READ_WRITE,matsize2);
	cl::Buffer vmatr(context,CL_MEM_READ_WRITE,matsizer);
	...
	kernel.setArg(3,mat2.cols);

	queue.enqueueNDRangeKernel(kernel,cl::NullRange,cl::NDRange(mat1.cols,mat2.rows),cl::NullRange,NULL,&event);
